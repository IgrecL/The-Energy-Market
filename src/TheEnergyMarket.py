...
if __name__ == "__main__":
    ...
    homes.append(home.Home(port, 0, temperature, 15, 10, 2.0, 1.0, 1))
    homes.append(home.Home(port, 1, temperature, 15, 10, 2.0, 1.0, 2))
    homes.append(home.Home(port, 2, temperature, 15, 1000, 1.0, 1.0, 2))
